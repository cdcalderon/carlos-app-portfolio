        ...
        <Row>
          ...
          <Col md={6} className="skills">
            ...
            <div className="skills-container">
              <Progress name="Solidity" value={90} delay={1100} />
              <Progress name="React" value={50} delay={1100} />
              <Progress name="Angular" value={80} delay={1100} />
              <Progress name="Hardhat, Truffle" value={40} delay={1100} />
              <Progress name="Asp.Net Core, C#" value={100} delay={1100} />
